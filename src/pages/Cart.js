      ...
      <div className='min-h-screen bg-gray-50'>
        ...
        <div className='bg-gradient-to-r from-slate-900 to-slate-800 text-white py-8 sm:py-12'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <h1 className='text-3xl sm:text-4xl font-bold mb-2'>Arcade Cart</h1>
            <p className='text-gray-300'>Your selected arcade titles</p>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='text-center max-w-md mx-auto'>
            ...
            <Link
              to='/games'
              className='inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-8 py-4 rounded-lg font-bold hover:from-blue-600 hover:to-cyan-600 transition-all shadow-lg'
            >
            ...
            {/* Suggestions */}
            <div className='mt-8 p-4 arcade-suggestions-panel rounded-lg border mobile-hide-on-small'>
              <h4 className='text-sm font-semibold arcade-suggestions-title mb-3'>Popular Categories:</h4>
              <div className='flex flex-wrap gap-2 justify-center'>
                {[
                  { name: 'Action', emoji: 'A' },
                  { name: 'RPG', emoji: 'R' },
                  { name: 'Strategy', emoji: 'S' },
                  { name: 'Adventure', emoji: 'D' }
                ].map((category) => (
                  <Link
                    key={category.name}
                    to={`/games?search=${category.name}`}
                    className='px-4 py-2 arcade-suggestion-chip rounded-full text-sm transition-colors border flex items-center gap-1'
                  >
          ...
          <div className='lg:col-span-1'>
            <div className='bg-white rounded-lg shadow-md p-6 sticky top-6'>
              ...
              <div className='mt-8 space-y-3'>
                <button className='w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-4 px-6 rounded-lg font-bold hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg'>
              ...
              {/* Cart Stats */}
              <div className='mt-6 p-4 bg-blue-50 rounded-lg mobile-hide-on-small'>
